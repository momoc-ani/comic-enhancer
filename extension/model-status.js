const PROFILE_LABELS = Object.freeze({
  ...
  "flux2-klein-9b-fast-lowres": "FLUX.2 Klein 9B FP8 0.70MP",
  "flux2-klein-9b-fast-lowres+realcugan-se-2x":
    "FLUX.2 Klein 9B FP8 0.70MP · Real-CUGAN 2x",
...
const MODE_TITLES = Object.freeze({
  ...
  flux2_9b_fast_lowres: "9B FP8 低分辨率快速档",
      ...
      capabilities &&
        ((Array.isArray(advertisedModes) && !advertisedModes.includes(mode)) ||
          ...
          (mode === "flux2_9b_fast_lowres" &&
            capabilities.flux2_9b_fast_lowres_available === false) ||
