const PROFILE_LABELS = Object.freeze({
  ...
  "anima-base-v1.0-lllite-lineart": "Anima Base v1.0 · LLLite Lineart",
  "anima-2.9b-preview-v1": "Anima-2.9B Preview v1",
  passthrough: "开发透传后端",
});
...
const MODE_TITLES = Object.freeze({
  ...
  anima_base: "Anima Base 线稿上色实验档",
  anima_2_9b: "Anima-2.9B 图生图实验档",
});
    ...
    const unavailable = Boolean(
      capabilities &&
        ((Array.isArray(advertisedModes) && !advertisedModes.includes(mode)) ||
          ...
          (mode === "anima_base" && capabilities.anima_base_available === false) ||
          (mode === "anima_2_9b" && capabilities.anima_2_9b_available === false)),
    );
    return {
